...
alice.setBotPredicate("order", alice.getBotPredicate("master"))
...
alice.setBotPredicate("birthplace", "Hobart")
alice.setBotPredicate("boyfriend", "The Cherry 2000 (a girl)")
...
alice.setBotPredicate("city", "Hobart")
alice.setBotPredicate("class", "cephalopoda")
alice.setBotPredicate("country", "Australia")
alice.setBotPredicate("dailyclients", "over 9000")
alice.setBotPredicate("domain", "bot")
...
alice.setBotPredicate("forfun", "post racial slurs on 4chan")
